...
{
    /// <summary>Argument class to <see cref="M:ICloud.Apis.Http.IHttpUnsuccessfulResponseHandler.HandleResponseAsync(ICloud.Apis.Http.HandleUnsuccessfulResponseArgs)" />.</summary>
