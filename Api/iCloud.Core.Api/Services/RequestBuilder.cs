...
{
    /// <summary>Utility class for building a URI using <see cref="M:ICloud.Apis.Requests.RequestBuilder.BuildUri" /> or a HTTP request using
    /// <see cref="M:ICloud.Apis.Requests.RequestBuilder.CreateRequest" /> from the query and path parameters of a REST call.</summary>
    public class RequestBuilder
    {
        ...
        /// <summary>
        /// The path portion of this request. It's appended to the <see cref="P:ICloud.Apis.Requests.RequestBuilder.BaseUri" /> and the parameters are
        /// substituted from the <see cref="P:ICloud.Apis.Requests.RequestBuilder.PathParameters" /> dictionary.
        /// </summary>
        public string Path { get; set; }

        /// <summary>The HTTP method used for this request (such as GET, PUT, POST, etc...).</summary>
        /// <remarks>The default Value is <see cref="F:ICloud.Apis.Http.HttpConsts.Get" />.</remarks>
        ...
        /// <summary>
        /// Builds the REST path string builder based on <see cref="P:ICloud.Apis.Requests.RequestBuilder.PathParameters" /> and the URI template spec
        ...
        public void AddParameter(RequestParameterType type, string name, string value)
        {
            ...
            if (value == null)
                RequestBuilder.Logger.Warning("Add parameter should not get null values. type={0}, name={1}", (object)type, name);
