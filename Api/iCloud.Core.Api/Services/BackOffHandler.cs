...
namespace iCloud.Apis.Core.Services
{
    ...
    public class BackOffHandler : IHttpUnsuccessfulResponseHandler, IHttpExceptionHandler
    {
        ...
        /// response. The default is <see cref="F:ICloud.Apis.Http.BackOffHandler.Initializer.DefaultHandleUnsuccessfulResponseFunc" />.
        /// </summary>
        ...
        /// default is <see cref="F:ICloud.Apis.Http.BackOffHandler.Initializer.DefaultHandleExceptionFunc" />.
        /// </summary>
        ...
        /// will block for x milliseconds (x is defined by the <see cref="P:ICloud.Apis.Http.BackOffHandler.BackOff" /> instance), and this handler
        /// returns <c>true</c>.
        /// </summary>
        ...
        public class Initializer
        {
            ...
            /// abnormal HTTP response. The default is <see cref="F:ICloud.Apis.Http.BackOffHandler.Initializer.DefaultHandleUnsuccessfulResponseFunc" />.
            /// </summary>
            public Func<HttpResponseMessage, bool> HandleUnsuccessfulResponseFunc { get; set; }

            /// <summary>
            /// Gets or sets a delegate function which indicates whether this back-off handler should handle an
            /// exception. The default is <see cref="F:ICloud.Apis.Http.BackOffHandler.Initializer.DefaultHandleExceptionFunc" />.
            /// </summary>
