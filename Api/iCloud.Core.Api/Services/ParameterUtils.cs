...
{
    /// <summary>
    /// Utility class for iterating on <see cref="T:ICloud.Apis.Util.RequestParameterAttribute" /> properties in a request object.
    /// </summary>
    public static class ParameterUtils
    {
        ...
        /// <see cref="T:ICloud.Apis.Util.RequestParameterAttribute" /> attribute.
        /// </summary>
        /// <param name="request">
        /// A request object which contains properties with
        /// <see cref="T:ICloud.Apis.Util.RequestParameterAttribute" /> attribute. Those properties will be serialized
        ...
        /// <param name="request">
        /// A request object which contains properties with
        /// <see cref="T:ICloud.Apis.Util.RequestParameterAttribute" /> attribute. Those properties will be set
        ...
        /// <param name="request">
        /// A request object which contains properties with
        /// <see cref="T:ICloud.Apis.Util.RequestParameterAttribute" /> attribute. Those properties will be set in the
        ...
        /// <summary>
        /// Iterates over all <see cref="T:ICloud.Apis.Util.RequestParameterAttribute" /> properties in the request
